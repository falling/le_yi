...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link com.example.falling.leyi.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.example.falling.leyi.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
